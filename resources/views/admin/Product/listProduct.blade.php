...
@section('content')
    ...
    <section class="content" id="app">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table id="tableExport" class="display table table-hover table-checkable order-column m-t-20 width-per-100">
                                    ...
                                    <tbody>
                                    @php $i=1; @endphp
                                    @foreach($listproduct as $listprod)
                                       <tr>
                                        ...
                                        <td>
                                           {{-- <img src="/upload/Product/{{$listprod->pimage}}" style="width: 13%" alt="">--}}
                                            {{$listprod->title}}
                                        </td>
                                        <td>

                                            {{Helper::getCategory($listprod->catid)}}
                                        </td>
                                        <td>23 تومان</td>
                                        <td>12</td>
                                        <td>
                                           @if($listprod->count ==0)
                                                <span class="label l-bg-orange shadow-style">نا موجود</span>
                                               @else
                                                <span class="label l-bg-purple shadow-style">موجود</span>
                                               @endif
                                        </td>
                                        <td>
                                            <button class="btn tblActnBtn" data-toggle="modal"  :data-target="'#exampleModal'+{{$listprod->id}}">
                                                <i class="material-icons">mode_edit</i>
                                            </button>
                                            <button class="btn tblActnBtn" @click="deletepro({{$listprod->id}})">>
        ...
        @foreach($listproduct as $listprod)
            <div class="modal fade" id="exampleModal{{$listprod->id}}" tabindex="-1" role="dialog"
                 aria-labelledby="formModal" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="formModal">   ویرایش محصول {{$listprod->title}}   </h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="email_address1" value="{{$listprod->title}}" v-model="titlePro" class="form-control"
                                    >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="email_address2" value="{{$listprod->price}}" v-model="PricePro" class="form-control"
                                    >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="email_address3" value="{{$listprod->count}}" v-model="CountPro" class="form-control"
                                    >
                                </div>
                            </div>
                            ...
                            <br>
                            <button v-on:click="EditProduct({{$listprod->id}})" type="button" class="btn btn-primary m-t-15 waves-effect">ویرایش</button>
